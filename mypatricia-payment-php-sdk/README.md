# Payment PHP SDK :wink:

> Class documentation can be found here [https://iolufemi.github.io/Flutterwave-Payment-PHP-SDK/packages/Default.html](https://iolufemi.github.io/Flutterwave-Payment-PHP-SDK/packages/Default.html)

Use this library to integrate your PHP app to Payment.
...
- ref `Your transaction reference. It must be unique per transaction.  By default, the Payment class generates a unique transaction reference for each transaction. Pass this parameter only if you uncommented the related section in the script below.`
...
$payment = new Payment($publicKey, $secretKey, $prefix, $env, $overrideRef);
...
You can also find the class documentation in the docs folder. There you will find documentation for the `Payment` class and the `EventHandlerInterface`.
